...
--	Result.Message = "Hello World"
	...
	Result.Message = "Recommended Somali Pirate Kit"
	if Result.Percentage == 1.0 then
		self.CurrentTime = 0
		Result.Percentage = 0.0
		player.ShowGameMessage(User, "The recommended kit for this mission is Somali Pirate look", "Center", 10.0)
		player.ShowGameMessage(User, "Recommended Uniform: T-Shirt and Jeans with black Chest Rig ", "Center", 10.0)
