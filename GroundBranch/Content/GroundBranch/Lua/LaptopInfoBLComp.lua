...
--	Result.Message = "Hello World"
	...
	Result.Message = "Recommended Seal Team Six Kit"
	if Result.Percentage == 1.0 then
		self.CurrentTime = 0
		Result.Percentage = 0.0
		player.ShowGameMessage(User, "The recommended kit for this mission is Seal Team Six look", "Center", 10.0)
		player.ShowGameMessage(User, "Recommended Uniform: Full AOR-1 Kit and Night Vision", "Center", 10.0)
		player.ShowGameMessage(User, "Recommended Weapons: HK416", "Center", 10.0)
